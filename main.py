...
def main():
    ...
    config_directory = config.get('config_directory') if config else None
    uml_report_output = config.get('uml_report_output') if config else None
    # project_name, config_directory, languages_directory, uml_report_output = load_config_keys()
    ...
    # uml_report_output = config['uml_report_output']
